  ...
  return shell('💡 使用帮助', [
    divMd(
      [
        ...
        '- `/effort [level|auto|default]` — 当前 session 的 reasoning effort；Claude 支持 low/medium/high/xhigh/max 和 ultracode session-only 模式，Codex 支持 none/minimal/low/medium/high/xhigh',
        '- `/model [default|<model-id>]` — 当前 session 的模型覆盖；Claude 支持 best/opus/opus[1m]/sonnet/sonnet[1m]/sonnet5/haiku/fable/fable5 alias 和完整模型 ID',
